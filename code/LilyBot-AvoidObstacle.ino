/*
  //Lily∞Bot
  LilyBot-AvoidObstacle.ino
This program will implement bang-bang control obstacle avoidanc on the LilyBot using 4 sonar sensoS.
...
int state  = 0;                       //{front, back, left, right}
...
int robotSpeed = 200;           //robot speed
